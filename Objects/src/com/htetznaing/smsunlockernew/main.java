...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.smsunlockernew", "com.htetznaing.smsunlockernew.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.smsunlockernew", "com.htetznaing.smsunlockernew.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.smsunlockernew.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 74;BA.debugLine="StartActivity(About)";
...
mostCurrent._adview1.Initialize2(mostCurrent.activityBA,"AdView1","ca-app-pub-4173348573252986/4080989757",mostCurrent._adview1.SIZE_SMART_BANNER);
 //BA.debugLineNum = 41;BA.debugLine="Dim height As Int";
_height = 0;
 //BA.debugLineNum = 42;BA.debugLine="If GetDeviceLayoutValues.ApproximateScreenSize <";
if (anywheresoftware.b4a.keywords.Common.GetDeviceLayoutValues(mostCurrent.activityBA).getApproximateScreenSize()<6) { 
 //BA.debugLineNum = 44;BA.debugLine="If 100%x > 100%y Then height = 32dip Else height";
...
_height = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50));};
 ...
 //BA.debugLineNum = 47;BA.debugLine="height = 90dip";
_height = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90));
 };
 //BA.debugLineNum = 49;BA.debugLine="Activity.AddView(AdView1, 0dip, 100%y - height, 1";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._adview1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-_height),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_height);
 //BA.debugLineNum = 50;BA.debugLine="AdView1.LoadAd";
mostCurrent._adview1.LoadAd();
 //BA.debugLineNum = 52;BA.debugLine="AdView2.Initialize(\"AdView2\",\"ca-app-pub-41733485";
mostCurrent._adview2.Initialize(mostCurrent.activityBA,"AdView2","ca-app-pub-4173348573252986/8511189350");
 //BA.debugLineNum = 53;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd();
 //BA.debugLineNum = 55;BA.debugLine="t.Initialize(\"t\",20000)";
...
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 57;BA.debugLine="t1.Initialize(\"t1\",100)";
_t1.Initialize(processBA,"t1",(long) (100));
 //BA.debugLineNum = 58;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 60;BA.debugLine="Activity.AddMenuItem3(\"About\",\"About\",LoadBitmap(F";
mostCurrent._activity.AddMenuItem3((java.lang.CharSequence)("About"),"About",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"about.png").getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 62;BA.debugLine="Activity.Title = \"SMS Bypasser\"";
mostCurrent._activity.setTitle((Object)("SMS Bypasser"));
 //BA.debugLineNum = 63;BA.debugLine="Activity.AddMenuItem(\"Holo\",\"btnHolo\")";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Holo"),"btnHolo");
 //BA.debugLineNum = 64;BA.debugLine="Activity.AddMenuItem(\"Holo Light\",\"btnHoloLight\")";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Holo Light"),"btnHoloLight");
 //BA.debugLineNum = 65;BA.debugLine="Activity.AddMenuItem(\"Holo Light Dark\",\"btnHoloLi";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Holo Light Dark"),"btnHoloLightDark");
 //BA.debugLineNum = 66;BA.debugLine="Activity.AddMenuItem(\"Old Android\",\"btnOld\")";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Old Android"),"btnOld");
 //BA.debugLineNum = 67;BA.debugLine="Activity.AddMenuItem(\"Material Light Dark\",\"btnMa";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Material Light Dark"),"btnMaterialLightDark");
 //BA.debugLineNum = 68;BA.debugLine="Activity.AddMenuItem(\"Material Light\",\"btnMateria";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Material Light"),"btnMaterialLight");
 //BA.debugLineNum = 69;BA.debugLine="Activity.AddMenuItem(\"Material\",\"btnMaterial\")";
mostCurrent._activity.AddMenuItem((java.lang.CharSequence)("Material"),"btnMaterial");
...
public static String  _adview2_adclosed() throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Sub AdView2_AdClosed";
 //BA.debugLineNum = 158;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd();
...
mostCurrent._adview1 = new anywheresoftware.b4a.admobwrapper.AdViewWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim AdView2 As InterstitialAd";
...
s1._process_globals();
 ...
 //BA.debugLineNum = 16;BA.debugLine="Dim Theme_Value As Int";
_theme_value = 0;
 //BA.debugLineNum = 17;BA.debugLine="Dim t,t1 As Timer";
...
public static String  _start_click() throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub start_Click";
 //BA.debugLineNum = 78;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 81;BA.debugLine="StartService(SmsUnlocker)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._smsunlocker.getObject()));
 }else {
 //BA.debugLineNum = 83;BA.debugLine="Msgbox(\"No have Root Access!\" ,\"Error\")";
...
public static String  _stop_click() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Sub stop_Click";
 //BA.debugLineNum = 88;BA.debugLine="t1.Enabled = True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _t_tick() throws Exception{
 ...
 //BA.debugLineNum = 154;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.Lo";
...
public static String  _t1_tick() throws Exception{
 ...
 //BA.debugLineNum = 149;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
if (mostCurrent._adview2.getReady()) { 
mostCurrent._adview2.Show();}
else {
mostCurrent._adview2.LoadAd();};
 //BA.debugLineNum = 150;BA.debugLine="t1.Enabled = False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
