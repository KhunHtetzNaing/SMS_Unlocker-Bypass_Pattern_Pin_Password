...
public class ads extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.smsunlockernew", "com.htetznaing.smsunlockernew.ads");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.smsunlockernew", "com.htetznaing.smsunlockernew.ads");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.smsunlockernew.ads", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="t.Initialize(\"t\",100)";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 23;BA.debugLine="Sub t_tick";
 //BA.debugLineNum = 24;BA.debugLine="If AdView2.Ready Then AdView2.Show Else AdView2.L";
if (mostCurrent._adview2.getReady()) { 
mostCurrent._adview2.Show();}
else {
mostCurrent._adview2.LoadAd();};
 //BA.debugLineNum = 25;BA.debugLine="t.Enabled = False";
