...
public class s1 extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.smsunlockernew", "com.htetznaing.smsunlockernew.s1");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.smsunlockernew.s1", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
