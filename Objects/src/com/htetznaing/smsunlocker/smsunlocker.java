...
public class smsunlocker extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.htetznaing.smsunlocker", "com.htetznaing.smsunlocker.smsunlocker");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.smsunlocker.smsunlocker", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
