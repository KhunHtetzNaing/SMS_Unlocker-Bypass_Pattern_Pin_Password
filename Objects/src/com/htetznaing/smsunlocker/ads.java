...
public class ads extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.smsunlocker", "com.htetznaing.smsunlocker.ads");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.smsunlocker", "com.htetznaing.smsunlocker.ads");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.smsunlocker.ads", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 17;BA.debugLine="t.Initialize(\"t\",100)";
...
_t.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 20;BA.debugLine="AdView2.Initialize(\"AdView2\",\"ca-app-pub-41733485";
mostCurrent._adview2.Initialize(mostCurrent.activityBA,"AdView2","ca-app-pub-4173348573252986/8871242155");
 //BA.debugLineNum = 21;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd(mostCurrent.activityBA);
 //BA.debugLineNum = 22;BA.debugLine="AdView2.Show";
...
public static String  _t_tick() throws Exception{
 //BA.debugLineNum = 27;BA.debugLine="Sub t_tick";
 //BA.debugLineNum = 28;BA.debugLine="If p.SdkVersion > 19 Then";
if (mostCurrent._p.getSdkVersion()>19) { 
 //BA.debugLineNum = 29;BA.debugLine="If AdView2.Status=AdView2.Status_AdReadyToShow Th";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_AdReadyToShow) { 
 //BA.debugLineNum = 30;BA.debugLine="AdView2.Show";
mostCurrent._adview2.Show(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 33;BA.debugLine="If AdView2.Status=AdView2.Status_Dismissed Then";
if (mostCurrent._adview2.Status==mostCurrent._adview2.Status_Dismissed) { 
 //BA.debugLineNum = 34;BA.debugLine="AdView2.LoadAd";
mostCurrent._adview2.LoadAd(mostCurrent.activityBA);
 };
